...
public class
	ProductContentCommerceMLRecommendationsRelatedItemCollectionProvider
	...
	public InfoPage<CPDefinition> getCollectionInfoPage(
		...
		try {
			...
			Stream<ProductContentCommerceMLRecommendation> stream =
				productContentCommerceMLRecommendationList.stream();
