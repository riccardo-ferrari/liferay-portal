...
public class AccountCategoryForecastResourceImpl
	...
	private void _createItem(AccountCategoryForecast item) throws Exception {
		...
		if (item.getActual() != null) {
			assetCategoryCommerceMLForecast.setActual(item.getActual());
		}

		assetCategoryCommerceMLForecast.setAssetCategoryId(item.getCategory());
		assetCategoryCommerceMLForecast.setCommerceAccountId(item.getAccount());
		assetCategoryCommerceMLForecast.setCompanyId(
			contextCompany.getCompanyId());
		assetCategoryCommerceMLForecast.setForecast(item.getForecast());
		assetCategoryCommerceMLForecast.setForecastLowerBound(
			item.getForecastLowerBound());
		assetCategoryCommerceMLForecast.setForecastUpperBound(
			item.getForecastUpperBound());
		...
		assetCategoryCommerceMLForecast.setTimestamp(item.getTimestamp());
