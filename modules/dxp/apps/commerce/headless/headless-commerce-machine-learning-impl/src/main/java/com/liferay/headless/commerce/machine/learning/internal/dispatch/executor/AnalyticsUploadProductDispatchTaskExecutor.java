...
public class AnalyticsUploadProductDispatchTaskExecutor
	...
	public static final String KEY = "analytics-upload-product-v2";
	...
	public void doExecute(
		...
		try {
			_analyticsBatchExportImportManager.exportToAnalyticsCloud(
				"analytics-category", dispatchTrigger.getCompanyId(), null,
			...
			_analyticsBatchExportImportManager.exportToAnalyticsCloud(
				"analytics-product", dispatchTrigger.getCompanyId(), null,
				message -> _updateDispatchLog(
					dispatchLog.getDispatchLogId(), dispatchTaskExecutorOutput,
					message),
			...
			_analyticsBatchExportImportManager.exportToAnalyticsCloud(
				"analytics-product-channel", dispatchTrigger.getCompanyId(),
				null,
				message -> _updateDispatchLog(
					dispatchLog.getDispatchLogId(), dispatchTaskExecutorOutput,
					message),
