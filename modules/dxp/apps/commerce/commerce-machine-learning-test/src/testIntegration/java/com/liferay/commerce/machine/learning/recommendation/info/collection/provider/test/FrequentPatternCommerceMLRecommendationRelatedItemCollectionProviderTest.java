...
public class
	...
	private List<FrequentPatternCommerceMLRecommendation>
		...
		for (int i = 0; i < DEFAULT_PRODUCT_COUNT; i++) {
			...
			for (int j = 0; j < DEFAULT_RECOMMENDATION_COUNT; j++) {
				FrequentPatternCommerceMLRecommendation
					frequentPatternCommerceMLRecommendation =
	...
	private FrequentPatternCommerceMLRecommendation
			_createFrequentPatternCommerceMLRecommendation(long antecedentId)
		throws Exception {
		...
		frequentPatternCommerceMLRecommendation.setAntecedentIds(
			new long[] {antecedentId});
		frequentPatternCommerceMLRecommendation.setAntecedentIdsLength(1);
