...
public class ChannelSerDes {
	...
	public static String toJSON(Channel channel) {
		...
		if (channel.getProductChannelId() != null) {
			...
			sb.append("\"productChannelId\": ");

			sb.append(channel.getProductChannelId());
		}
	...
	public static Map<String, String> toMap(Channel channel) {
		...
		if (channel.getProductChannelId() == null) {
			map.put("productChannelId", null);
		}
		else {
			map.put(
				"productChannelId",
				String.valueOf(channel.getProductChannelId()));
		}
	...
	public static class ChannelJSONParser extends BaseJSONParser<Channel> {
		...
		protected void setField(
			...
			else if (Objects.equals(jsonParserFieldName, "productChannelId")) {
				if (jsonParserFieldValue != null) {
					channel.setProductChannelId(
