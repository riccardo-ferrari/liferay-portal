...
public interface ChannelResource {
	...
	public HttpInvoker.HttpResponse
			getProductByExternalReferenceCodeChannelsPageHttpResponse(
				String externalReferenceCode, Pagination pagination)
		throws Exception;
	...
	public HttpInvoker.HttpResponse getProductIdChannelsPageHttpResponse(
			Long id, Pagination pagination)
		throws Exception;
	...
	public static class ChannelResourceImpl implements ChannelResource {
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-commerce-admin-catalog/v1.0/products/by-externalReferenceCode/{externalReferenceCode}/channels");
		...
		public Page<Channel> getProductIdChannelsPage(
			...
			HttpInvoker.HttpResponse httpResponse =
				getProductIdChannelsPageHttpResponse(id, pagination);
		...
		public HttpInvoker.HttpResponse getProductIdChannelsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-commerce-admin-catalog/v1.0/products/{id}/channels");
