...
public abstract class BaseChannelResourceImpl
	...
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "Channel")})
	public Channel getProductChannel(
			@NotNull @Parameter(hidden = true) @PathParam("id") Long id)
		throws Exception {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/products/by-externalReferenceCode/{externalReferenceCode}/channels'  -u 'test@liferay.com:test'
	 */
	@Override
	@GET
	@Parameters(
	...
	@Path("/products/by-externalReferenceCode/{externalReferenceCode}/channels")
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "Channel")})
	public Page<Channel> getProductByExternalReferenceCodeChannelsPage(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-commerce-admin-catalog/v1.0/products/{id}/channels'  -u 'test@liferay.com:test'
	 */
	@Override
	@GET
	@Parameters(
