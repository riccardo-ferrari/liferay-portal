...
import com.liferay.headless.commerce.admin.catalog.client.resource.v1_0.ChannelResource;
...
public abstract class BaseChannelResourceTestCase {
	...
	public void testDeleteProductChannel() throws Exception {
		...
		Channel channel = testDeleteProductChannel_addChannel();

		assertHttpResponseStatusCode(
			204,
			channelResource.deleteProductChannelHttpResponse(channel.getId()));

		assertHttpResponseStatusCode(
			404,
			channelResource.getProductChannelHttpResponse(channel.getId()));
	...
	protected Channel testDeleteProductChannel_addChannel() throws Exception {
	...
	public void testGetProductChannel() throws Exception {
		Channel postChannel = testGetProductChannel_addChannel();

		Channel getChannel = channelResource.getProductChannel(
			postChannel.getId());
	...
	protected Channel testGetProductChannel_addChannel() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}
	...
	@Test
	public void testGetProductByExternalReferenceCodeChannelsPage()
		throws Exception {

		Page<Channel> page =
			channelResource.getProductByExternalReferenceCodeChannelsPage(
				testGetProductByExternalReferenceCodeChannelsPage_getExternalReferenceCode(),
				Pagination.of(1, 2));
		...
		String irrelevantExternalReferenceCode =
			testGetProductByExternalReferenceCodeChannelsPage_getIrrelevantExternalReferenceCode();

		if ((irrelevantExternalReferenceCode != null)) {
			Channel irrelevantChannel =
				testGetProductByExternalReferenceCodeChannelsPage_addChannel(
					irrelevantExternalReferenceCode, randomIrrelevantChannel());
			...
			assertEquals(
				Arrays.asList(irrelevantChannel),
		...
		Channel channel1 =
			testGetProductByExternalReferenceCodeChannelsPage_addChannel(
				externalReferenceCode, randomChannel());

		Channel channel2 =
			testGetProductByExternalReferenceCodeChannelsPage_addChannel(
				externalReferenceCode, randomChannel());

		page = channelResource.getProductByExternalReferenceCodeChannelsPage(
	...
	@Test
	public void testGetProductByExternalReferenceCodeChannelsPageWithPagination()
		throws Exception {
	...
	@Test
	public void testGetProductIdChannelsPage() throws Exception {
		Page<Channel> page = channelResource.getProductIdChannelsPage(
			testGetProductIdChannelsPage_getId(), Pagination.of(1, 2));

		Assert.assertEquals(0, page.getTotalCount());

		Long id = testGetProductIdChannelsPage_getId();
		Long irrelevantId = testGetProductIdChannelsPage_getIrrelevantId();

		if ((irrelevantId != null)) {
			Channel irrelevantChannel = testGetProductIdChannelsPage_addChannel(
				irrelevantId, randomIrrelevantChannel());

			page = channelResource.getProductIdChannelsPage(
		...
		Channel channel1 = testGetProductIdChannelsPage_addChannel(
			id, randomChannel());

		Channel channel2 = testGetProductIdChannelsPage_addChannel(
			id, randomChannel());
	...
	@Test
	public void testGetProductIdChannelsPageWithPagination() throws Exception {
		Long id = testGetProductIdChannelsPage_getId();
		...
		Channel channel3 = testGetProductIdChannelsPage_addChannel(
			id, randomChannel());

		Page<Channel> page1 = channelResource.getProductIdChannelsPage(
			id, Pagination.of(1, 2));
		...
		Page<Channel> page2 = channelResource.getProductIdChannelsPage(
		...
		Page<Channel> page3 = channelResource.getProductIdChannelsPage(
	...
	protected Channel testGetProductIdChannelsPage_addChannel(
			Long id, Channel channel)
		throws Exception {
	...
	protected Long testGetProductIdChannelsPage_getId() throws Exception {
		throw new UnsupportedOperationException(
			"This method needs to be implemented");
	}

	protected Long testGetProductIdChannelsPage_getIrrelevantId()
		throws Exception {
	...
	protected void assertValid(Channel channel) throws Exception {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("productChannelId", additionalAssertFieldName)) {
				if (channel.getProductChannelId() == null) {
					valid = false;
				}
	...
	protected boolean equals(Channel channel1, Channel channel2) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("productChannelId", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						channel1.getProductChannelId(),
						channel2.getProductChannelId())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("productChannelId")) {
			throw new IllegalArgumentException(
				"Invalid entity field " + entityFieldName);
		}
		...
		return new Channel() {
			{
				...
				productChannelId = RandomTestUtil.randomLong();
