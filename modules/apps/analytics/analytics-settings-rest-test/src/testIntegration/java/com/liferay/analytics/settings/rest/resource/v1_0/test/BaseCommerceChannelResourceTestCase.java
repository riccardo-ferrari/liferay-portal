...
public abstract class BaseCommerceChannelResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		commerceChannel.setRelatedSite(regex);
		...
		Assert.assertEquals(regex, commerceChannel.getRelatedSite());
	}

	@Test
	public void testGetCommerceChannelPage() throws Exception {
		Page<CommerceChannel> page =
			commerceChannelResource.getCommerceChannelPage(
				Pagination.of(1, 10));

		long totalCount = page.getTotalCount();

		CommerceChannel commerceChannel1 =
			testGetCommerceChannelPage_addCommerceChannel(
		...
		page = commerceChannelResource.getCommerceChannelPage(
			Pagination.of(1, 10));
	...
	@Test
	public void testGetCommerceChannelPageWithPagination() throws Exception {
		Page<CommerceChannel> totalPage =
			commerceChannelResource.getCommerceChannelPage(null);
	...
	protected CommerceChannel testGetCommerceChannelPage_addCommerceChannel(
	...
	protected void assertValid(CommerceChannel commerceChannel)
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("relatedSite", additionalAssertFieldName)) {
				if (commerceChannel.getRelatedSite() == null) {
					valid = false;
				}
	...
	protected boolean equals(
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("relatedSite", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						commerceChannel1.getRelatedSite(),
						commerceChannel2.getRelatedSite())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("relatedSite")) {
			sb.append("'");
			sb.append(String.valueOf(commerceChannel.getRelatedSite()));
			sb.append("'");
		...
		return new CommerceChannel() {
			{
				...
				relatedSite = StringUtil.toLowerCase(
					RandomTestUtil.randomString());
			}
		};
	}
