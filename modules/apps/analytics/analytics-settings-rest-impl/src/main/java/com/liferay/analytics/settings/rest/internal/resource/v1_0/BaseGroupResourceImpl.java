...
public abstract class BaseGroupResourceImpl implements GroupResource {
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/analytics-settings-rest/v1.0/groups'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
				in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY,
				name = "includeCommerceChannels"
			),
			@io.swagger.v3.oas.annotations.Parameter(
				in = io.swagger.v3.oas.annotations.enums.ParameterIn.QUERY,
				name = "page"
	...
	public Page<Group> getGroupsPage(
			...
			@javax.ws.rs.QueryParam("includeCommerceChannels")
			Boolean includeCommerceChannels,
