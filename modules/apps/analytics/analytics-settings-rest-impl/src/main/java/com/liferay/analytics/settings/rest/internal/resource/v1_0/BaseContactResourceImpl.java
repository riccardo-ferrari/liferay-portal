...
public abstract class BaseContactResourceImpl implements ContactResource {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/analytics-settings-rest/v1.0/contacts/configuration' -d $'{"syncAllAccounts": ___, "syncAllContacts": ___, "syncedAccountGroupIds": ___, "syncedOrganizationIds": ___, "syncedUserGroupIds": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "Contact")}
	)
