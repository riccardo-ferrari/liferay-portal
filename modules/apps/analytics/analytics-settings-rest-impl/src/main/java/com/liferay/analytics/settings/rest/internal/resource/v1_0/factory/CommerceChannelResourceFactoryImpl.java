 ...
 * @generated
 */
@Component(immediate = true, service = CommerceChannelResource.Factory.class)
@Generated("")
public class CommerceChannelResourceFactoryImpl
	...
	public CommerceChannelResource.Builder create() {
		return new CommerceChannelResource.Builder() {
			...
			public CommerceChannelResource build() {
				...
				return _commerceChannelResourceProxyProviderFunction.apply(
	...
	protected void activate() {
		CommerceChannelResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		CommerceChannelResource.FactoryHolder.factory = null;
	}
	...
	private static final Function<InvocationHandler, CommerceChannelResource>
