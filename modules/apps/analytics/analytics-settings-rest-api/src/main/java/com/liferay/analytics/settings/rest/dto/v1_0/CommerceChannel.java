...
public class CommerceChannel implements Serializable {
	...
	@JsonIgnore
	public void setRelatedSite(
		UnsafeSupplier<String, Exception> relatedSiteUnsafeSupplier) {

		try {
			relatedSite = relatedSiteUnsafeSupplier.get();
		}
		catch (RuntimeException re) {
			throw re;
		}
