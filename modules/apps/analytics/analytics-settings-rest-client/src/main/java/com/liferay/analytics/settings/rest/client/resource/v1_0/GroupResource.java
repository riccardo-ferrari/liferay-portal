...
public interface GroupResource {
	...
	public HttpInvoker.HttpResponse getGroupsPageHttpResponse(
			Boolean includeCommerceChannels, Pagination pagination)
		throws Exception;
	...
	public static class GroupResourceImpl implements GroupResource {
		...
		public Page<Group> getGroupsPage(
			...
			HttpInvoker.HttpResponse httpResponse = getGroupsPageHttpResponse(
				includeCommerceChannels, pagination);
			...
			try {
				return Page.of(content, GroupSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse getGroupsPageHttpResponse(
			...
			if (includeCommerceChannels != null) {
				httpInvoker.parameter(
					"includeCommerceChannels",
					String.valueOf(includeCommerceChannels));
			}
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/analytics-settings-rest/v1.0/groups");
