...
public class CommerceChannelSerDes {
	...
	public static String toJSON(CommerceChannel commerceChannel) {
		...
		if (commerceChannel.getRelatedSite() != null) {
			...
			sb.append("\"relatedSite\": ");

			sb.append("\"");

			sb.append(_escape(commerceChannel.getRelatedSite()));
	...
	public static Map<String, String> toMap(CommerceChannel commerceChannel) {
		...
		if (commerceChannel.getRelatedSite() == null) {
			map.put("relatedSite", null);
		}
		else {
			map.put(
				"relatedSite",
				String.valueOf(commerceChannel.getRelatedSite()));
		}
	...
	public static class CommerceChannelJSONParser
		...
		protected void setField(
			...
			else if (Objects.equals(jsonParserFieldName, "relatedSite")) {
				if (jsonParserFieldValue != null) {
					commerceChannel.setRelatedSite(
						(String)jsonParserFieldValue);
				}
			}
		}
