...
public interface CommerceChannelResource {
	...
	public HttpInvoker.HttpResponse getCommerceChannelPageHttpResponse(
	...
	public static class CommerceChannelResourceImpl
		...
		public Page<CommerceChannel> getCommerceChannelPage(
				Pagination pagination)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getCommerceChannelPageHttpResponse(pagination);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/analytics-settings-rest/v1.0/commerce-channel");
